...
int main(){			//programa principal
	system("color f0");
	Vertice* v;			//crear un apuntador a objetos de tipo vertices
	...
	v = new Vertice[n];			//creacion dinamica de n elementos de tipo vertice y asociarlos al apuntador v
...
void leerVertices(Vertice v[], int n){		//funcion que permite lectura de valores para el conjunto de vertices
	...
	if(n>= 0){
		...
		TipoG vl;
		cout << endl << "Valor a contener en el Vertice: ";
		cin >> vl;
		v[n].setNum(n);
